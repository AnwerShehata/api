        ...
        child: GestureDetector(onTap: onTapPositioned,
        child: Container(
        ...
        //===my_StackPost=============================================new
        Widget my_StackPost(BuildContext context ,{
        String imagURL ="" ,
        ...
        //===my_StackPost=============================================new
        Widget my_StackSections(BuildContext context , {
        String title,
        String description,
        IconData icons,
